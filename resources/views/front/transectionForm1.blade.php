                                                        ...
                                                        <select id="target" @change="onChange($event)" v-model="type" name="type" class="form-control type" required="">
                                                            ...
                                                            <select>
                                                                ...
                                                                <div class="row mb-4 old-rec" v-if="getPerson.length > 0">
                                                                    ...
                                                                    <div class="olf">
                                                                        <select @change="findAccountHolder($event)" v-model="saved_person" class="form-control">
                                                                            <option disabled selected>Please select name</option>
                                                                            <option v-for="(number) in getPerson" :value="number">
                                                                                @{{number}}
                                                                            </option>
                                                                ...
                                                                <div id="Bank-Deposit" class="inv">
                                                                    <div class="login-form">
                                                                        <div class="newform">
                                                                            <h5>New Receiver:-<a @click="clearSelection" class="text-light mt-2 btn btn-sm btn-success">Clear
                                                                                    Selection</a></h5>
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-md-9">
                                                                                    ...
                                                                                    <input name="contact_number" class="form-control contact_number" id="full_name" type="number" :value="account_holder && account_holder.contact_number" :readonly="getDisabled" onKeyPress="if(this.value.length==10) return false">
                                        ...
                                        <input :value="account_holder && account_holder.full_name" type="text"
                                                    ...
                                                    @enderror
                                                                            ...
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-md-9">
                                                                                    <input type="text" name="account_holder_name" :value="account_holder && account_holder.account_holder_name" class="form-control account_holder_name" :readonly="getDisabled" required />
                                                                            ...
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-md-9">
                                                                                    <input type="text" name="bank_name" :value="account_holder && account_holder.bank_name" class="form-control bank_name" :readonly="getDisabled" required="" />
                                                                                    @error('bank_name')
                                                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                                                    @enderror
                                                                                </div>
                                                                            ...
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-md-9">
                                                                                    <input :value="account_holder && account_holder.bank_branch" type="text" name="bank_branch" :readonly="getDisabled" class="form-control bank_branch" required />
                                                                                    @error('bank_branch')
                                                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                                                    @enderror
                                                                                </div>
                                                                            ...
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-md-9">
                                                                                    <input :value="account_holder && account_holder.account_number" type="text" name="account_number" :readonly="getDisabled" class="form-control account_number" required />
                                        ...
                                        <select @change="findAccountHolder($event)" v-model="saved_person"
                                                    ...
                                                    <option v-for="(number) in getPerson" :value="number">
                                                        @{{number}}
                                                            ...
                                                            <div id="E-sewa" class="inv">
                                                                <div class="newform commonp">
                                        ...
                                        <select @change="findAccountHolder($event)" v-model="saved_person"
                                                    ...
                                                    <option v-for="(number) in getPerson" :value="number">
                                                        @{{number}}
                                                                    ...
                                                                    <h5>New Receiver:-<a @click="clearSelection" class="text-light mt-2 btn btn-sm btn-success">Reset
                                                                        </a></h5>
                                                                    <div class="form-group row">
                                                                        <label for="full_name" class="col-md-3 col-form-label">Esewa Id(Number):</label>
                                                                        <div class="col-md-9">
                                                                            <!-- <input type="text" id="full_name" class="form-control so" name="full-name" placeholder="Write Here"> -->
                                                                            <input type="number" name="esewa_number" class="form-control" required type="number" onKeyPress="if(this.value.length==10) return false">
                                                                            @error('esewa_number')
                                                                            <div class="alert alert-danger">{{ $message }}</div>
                                                                            @enderror
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-md-9">
                                                                            ...
                                                                            <input type="text" name="esewa_name" class="form-control" required type="text">
                                                                            @error('esewa_name')
                                                                            <div class="alert alert-danger">{{ $message }}</div>
                                                                            @enderror
                                                                        </div>
                                                            ...
                                                            <div id="Remit" class="inv">
                                                                <div class="newform">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-md-9">
                                                                            <!-- <input type="text" id="full_name" class="form-control so" name="full-name" placeholder="Write Here"> -->
                                                                            <input type="number" name="receiver_contact_number" class="form-control receiver_contact_number" required type="number" :readonly="getDisabled" :value="account_holder && account_holder.receiver_contact_number" onKeyPress="if(this.value.length==10) return false">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-md-9">
                                                                            <!-- <input type="text" id="email_address" class="form-control so" name="email-address" placeholder="Write Here"> -->
                                                                            <input :value="account_holder && account_holder.full_name" type="text" :readonly="getDisabled" name="full_name" class="form-control full_name" required />
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-md-9">
                                                                            ...
                                                                            <input type="text" name="pick_up_district" class="form-control pick_up_district" :readonly="getDisabled" :value="account_holder && account_holder.pick_up_district" />
...
<script>
    ...
    Swal.fire({
        ...
        icon: 'success',
        html: 'Thank You for doing business with us, Track your remit via ' +
...
<script>
    ...
    const SERVICE_CHARGE = {
        {
            $dashboard_composer - > service_charge
        }
    };
    const MAX_DEPOSIT_AMOUNT = {
        {
            $dashboard_composer - > transaction_limit_bank_deposit
        }
    }
    const MAX_REMIT_AMOUNT = {
        {
            $dashboard_composer - > transaction_limit_remit
        }
    }
    const MAX_ESEWA_AMOUNT = {
        {
            $dashboard_composer - > transaction_limit_esewa
        }
    }
